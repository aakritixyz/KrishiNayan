      ...
      <section className="relative min-h-screen w-full max-w-[430px] overflow-hidden bg-cream px-5 pb-32 pt-6 sm:min-h-[844px] sm:rounded-[36px]">
        ...
        <div className="mt-6 grid grid-cols-3 gap-2">
          ...
          <div className="rounded-[20px] border border-forest/10 bg-white p-3">
            ...
            <p className="mt-1 text-xs font-semibold text-forest">Villages</p>
            <p className="text-[10px] text-muted">Affected</p>
          </div>
        ...
        <div className="relative mt-5 h-[260px] overflow-hidden rounded-[26px] border border-forest/10 bg-[#e9efdc]">
          ...
          <span className="absolute left-7 top-8 text-xs font-semibold text-forest">
            Kondhwa
          </span>

          <span className="absolute right-9 top-10 text-xs font-semibold text-forest">
            Pisoli
          </span>

          <span className="absolute bottom-12 left-8 text-xs font-semibold text-forest">
            Holkarwadi
          </span>
        ...
        <div className="mt-5 flex gap-3 rounded-[24px] border border-danger/20 bg-white p-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm leading-5 text-muted">
              Conditions currently favour disease spread near your farm.
            </p>
